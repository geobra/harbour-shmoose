...
const QString Database::sqlMsgEncrypted_ = "encrypted";             // msg (send or received) encrypted? 0: false, 1: true
        ...
        else
        {
            ...
            {                
                QString sqlCreateCommand = "create table " + sqlMsgName_ + " (" + sqlId_ + " TEXT, " + sqlJid_ + " TEXT, "
                        ...
                        + sqlTimestamp_ + " INTEGER, " + sqlMsgType_ + " STRING, " + sqlMsgState_ + " INTEGER, " + sqlMsgEncrypted_ + " INTEGER)";
